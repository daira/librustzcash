...
pub(crate) mod tests {
    ...
    use zcash_client_backend::{
        ...
        data_api::{
            ...
            AccountBirthday, Ratio, ShieldedProtocol, WalletCommitmentTrees, WalletRead, WalletWrite,
        },
        decrypt_transaction,
    ...
    fn external_address_change_spends_detected_in_restore_from_seed() {
        ...
        assert_eq!(st.get_total_balance(AccountId::from(1)), NonNegativeAmount::ZERO);
